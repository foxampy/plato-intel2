<header class="s-header">
    <div class="header-middle">
        <div class="container">
            <div class="row row-header-middle align-items-center">
                <!-- Логотип -->
                <div class="col-logo">
                                ...
                                <div class="col-image">
                                    <div class="image">
                                        @isset(json_decode(setting('general.logo'))[0])
                                            <img src="{{asset('storage/'.json_decode(setting('general.logo'))[0]->download_link)}}" alt="{{env('APP_NAME')}}">
                                        @else
                                            <img src="{{asset('i/plato-intel-logo.png')}}" alt="{{env('APP_NAME')}}">
                                        @endisset
                                    </div>
                                </div>
                                <div class="col-text">
                ...
                <div class="col-actions">
                    ...
                    <button class="contacts-button" onclick="toggleContactsDropdown()">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
